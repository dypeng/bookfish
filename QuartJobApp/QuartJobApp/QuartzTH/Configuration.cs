...
namespace QuartzTH
{
	...
	public class Configuration
	{
		...
		private const string DefaultServiceName = "MiaoGouBackRunServer";
		private const string DefaultServiceDisplayName = "淼购商城服务";
		private const string DefaultServiceDescription = "淼购商城自动执行的操作服务";
